...
class LLM(RetryMixin, DebugMixin):
    ...
    def __init__(
        ...
        # Azure issue: https://github.com/All-Hands-AI/OpenReplica/issues/6777
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            if mock_function_calling and 'tools' in kwargs:
                ...
                if (
                    'openreplica-lm' in self.config.model
                ...
                if 'openreplica-lm' in self.config.model:
                    # If we don't have this, we might run into issue when serving openreplica-lm
                    # using SGLang

...
from app.llm.tool_names import (
    BROWSER_TOOL_NAME,
...
Requirement already satisfied: Jinja2>=3.1.2 in /home/openreplica/.local/lib/python3.10/site-packages (from flask) (3.1.3)
Requirement already satisfied: MarkupSafe>=2.0 in /home/openreplica/.local/lib/python3.10/site-packages (from Jinja2>=3.1.2->flask) (2.1.5)

...
from app.events.action.files import FileEditSource
...
from app.runtime.utils.request import send_request
from app.utils.http_session import HttpSession
...
class ActionExecutionClient(Runtime):
    ...
    async def call_tool_mcp(self, action: MCPAction) -> Observation:
        ...
        from app.mcp.utils import call_tool_mcp as call_tool_mcp_handler
        from app.mcp.utils import create_mcp_clients

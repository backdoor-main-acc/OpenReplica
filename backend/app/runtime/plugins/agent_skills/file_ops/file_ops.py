"""File operations module for OpenReplica agent.

This module provides a collection of file manipulation skills that enable the OpenReplica
...
from app.linter import DefaultLinter, LintResult

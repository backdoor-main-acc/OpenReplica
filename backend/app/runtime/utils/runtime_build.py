...
from app.core.exceptions import AgentRuntimeBuildError
from app.core.logger import openreplica_logger as logger
from app.runtime.builder import DockerRuntimeBuilder, RuntimeBuilder
...
def build_runtime_image(
    ...
    If dry_run is False, it will also build the OpenReplica runtime Docker image using the docker build folder.
...
def prep_build_folder(
    ...
    openhands_source_dir = Path(app.__file__).parent

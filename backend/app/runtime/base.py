...
from app.core.config import OpenReplicaConfig, SandboxConfig
from app.core.config.mcp_config import MCPConfig, MCPStdioServerConfig
from app.core.exceptions import AgentRuntimeDisconnectedError
from app.core.logger import openreplica_logger as logger
from app.events import EventSource, EventStream, EventStreamSubscriber
...
from app.events.serialization.action import ACTION_TYPE_TO_CLASS
from app.integrations.provider import (
    PROVIDER_TOKEN_TYPE,
    ProviderHandler,
    ProviderType,
)
from app.integrations.service_types import AuthenticationError
...
from app.runtime.utils.edit import FileEditRuntimeMixin
from app.runtime.utils.git_handler import CommandResult, GitHandler
...
class Runtime(FileEditRuntimeMixin):
    ...
    def maybe_setup_git_hooks(self):
        ...
        if not isinstance(read_obs, ErrorObservation):
            # If the existing hook wasn't created by OpenReplica, preserve it
            if 'This hook was installed by OpenReplica' not in read_obs.content:
...
# This hook was installed by OpenReplica

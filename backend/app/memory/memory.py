...
from app.events.event import Event, EventSource, RecallType
from app.events.observation.agent import (
    MicroagentKnowledge,
    RecallObservation,
)
from app.events.observation.empty import NullObservation
from app.events.stream import EventStream, EventStreamSubscriber
...
class Memory:
    ...
    def __init__(
        ...
        # from typically OpenReplica/microagents (i.e., the PUBLIC microagents)

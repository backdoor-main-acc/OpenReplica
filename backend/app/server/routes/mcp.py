...
from app.integrations.provider import ProviderToken
...
async def create_pr(
    ...
    logger.info('Calling OpenReplica MCP create_pr')

    request = get_http_request()
    headers = request.headers
    conversation_id = headers.get('X-OpenReplica-ServerConversation-ID', None)
...
async def create_mr(
    ...
    logger.info('Calling OpenReplica MCP create_mr')

...
from app.core.config import AgentConfig, LLMConfig, OpenReplicaConfig
from app.core.exceptions import AgentRuntimeUnavailableError
from app.core.logger import OpenReplicaLoggerAdapter
from app.core.schema.agent import AgentState
from app.events.action import ChangeAgentStateAction, MessageAction
...
from app.microagent.microagent import BaseMicroagent
...
from app.utils.async_utils import EXECUTOR, call_sync_from_async
from app.utils.shutdown_listener import should_continue
...
class AgentSession:
    ...
    def __init__(
        ...
        self.logger = OpenReplicaLoggerAdapter(

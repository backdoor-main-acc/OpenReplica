...
from app.core.config.mcp_config import MCPConfig, OpenReplicaMCPConfigImpl
...
from app.events.observation.agent import RecallObservation
...
from app.server.session.agent_session import AgentSession
...
class Session:
    ...
    def __init__(
        ...
        self.logger = OpenReplicaLoggerAdapter(extra={'session_id': sid})

...
async def run_session(
    ...
    if agent.config.enable_mcp:
        ...
        # FIXME: OpenReplica' SSE server may not be running when CLI mode is started
    ...
    # Show OpenReplica banner and session ID

...
async def handle_init_command(
    config: OpenReplicaConfig, event_stream: EventStream, current_dir: str
) -> tuple[bool, bool]:
...
def check_folder_security_agreement(config: OpenReplicaConfig, current_dir: str) -> bool:
        ...
        security_frame = Frame(
            TextArea(
                text=(
                    ...
                    f'   {current_dir}\n\n'
                    ' OpenReplica may read and execute files in this folder with your permission.'
                ),
                style=COLOR_GREY,
                read_only=True,
                wrap_lines=True,

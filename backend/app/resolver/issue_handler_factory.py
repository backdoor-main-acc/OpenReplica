...
from app.resolver.interfaces.github import GithubIssueHandler, GithubPRHandler
from app.resolver.interfaces.gitlab import GitlabIssueHandler, GitlabPRHandler

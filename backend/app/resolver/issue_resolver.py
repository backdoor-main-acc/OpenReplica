...
from app.core.config import AgentConfig, LLMConfig, OpenReplicaConfig, SandboxConfig
from app.core.logger import openreplica_logger as logger
from app.core.main import create_runtime, run_controller
from app.events.action import CmdRunAction, MessageAction
...
from app.events.stream import EventStreamSubscriber
from app.integrations.service_types import ProviderType
from app.resolver.interfaces.issue import Issue
from app.resolver.interfaces.issue_definitions import (
    ServiceContextIssue,
    ServiceContextPR,
)
from app.resolver.issue_handler_factory import IssueHandlerFactory
from app.resolver.resolver_output import ResolverOutput
from app.resolver.utils import (
    ...
    def _setup_sandbox_config(
        ...
        if (
            ...
            runtime_container_image = (
                f'ghcr.io/all-hands-ai/runtime:{app.__version__}-nikolaik'
            )

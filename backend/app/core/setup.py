...
from app.integrations.provider import ProviderToken, ProviderType
...
def create_memory(
    ...
    if runtime:
        ...
        # loads microagents from repo/.openreplica/microagents
...
def create_agent(config: OpenReplicaConfig) -> Agent:
...
def generate_sid(config: OpenReplicaConfig, session_name: str | None = None) -> str:

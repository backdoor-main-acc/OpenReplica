...
class OpenReplicaMCPConfig:
    @staticmethod
    def add_search_engine(app_config: 'OpenReplicaConfig') -> MCPStdioServerConfig | None:
        ...
        # Do not add search engine to MCP config in SaaS mode since it will be added by the OpenReplica server
        return None

    @staticmethod
    def create_default_mcp_server_config(
        host: str, config: 'OpenReplicaConfig', user_id: str | None = None
        ...
        stdio_servers = []
        search_engine_stdio_server = OpenReplicaMCPConfig.add_search_engine(config)

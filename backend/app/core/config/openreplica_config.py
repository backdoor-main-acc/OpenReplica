...
class OpenReplicaConfig(BaseModel):
    ...
    Attributes:
        ...
        mcp_host: Host for OpenReplica' default MCP server
    ...
    def model_post_init(self, __context: Any) -> None:
        ...
        if not OpenReplicaConfig.defaults_dict:  # Only set defaults_dict if it's empty
            OpenReplicaConfig.defaults_dict = model_defaults_to_dict(self)

...
from app.core.exceptions import LLMMalformedActionError
...
from app.events.action.commands import (
    CmdRunAction,
...
def handle_action_deprecated_args(args: dict[str, Any]) -> dict[str, Any]:
    # keep_prompt has been deprecated in https://github.com/All-Hands-AI/OpenReplica/pull/4881

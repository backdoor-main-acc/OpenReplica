...
from app.controller.replay import ReplayManager
from app.controller.state.state import State, TrafficControlState
from app.controller.stuck import StuckDetector
from app.core.config import AgentConfig, LLMConfig
...
from app.core.logger import LOG_ALL_EVENTS
...
from app.events.action.agent import CondensationAction, RecallAction
...
from app.events.serialization.event import event_to_trajectory, truncate_content
from app.llm.llm import LLM
from app.llm.metrics import Metrics, TokenUsage
...
class AgentController:
    ...
    async def start_delegate(self, action: AgentDelegateAction) -> None:
        ...
        OpenReplica is a multi-agentic system. A `task` is a conversation between
        OpenReplica (the whole system) and the user, which might involve one or more inputs
